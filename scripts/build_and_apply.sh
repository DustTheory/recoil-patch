...
i686-w64-mingw32-gcc -shared -o ../build/pusr32.dll ../build/user32.o ../build/menu.o ../src/user32/user32.def -static-libgcc
...
cp ../build/pusr32.dll $RECOIL_DIR/pusr32.dll
